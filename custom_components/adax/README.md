...
climate:
  - platform: adax
    account_id: "112395"  # replace with your client ID (see Adax WiFi app, Account Section)
    password: "6imtpX63D5WoRyKh"  # replace with your client SECRET (see Adax WiFi app, Account Section)
```
